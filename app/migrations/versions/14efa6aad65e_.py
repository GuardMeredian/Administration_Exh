...
revision: str = '14efa6aad65e'
down_revision: Union[str, None] = 'eb49878136e9'
...
def downgrade() -> None:
    ...
    sa.Column('age_months', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['breed_id'], ['breeds.id'], name='kitten_breed_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='kitten_pkey')
    )
